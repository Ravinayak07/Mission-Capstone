...
def toggle_sidebar_visibility():
    ...
    st.session_state.sidebar_visibility = not st.session_state.sidebar_visibility
...
st.markdown(
    """
    <h1 style='color: white; margin-top:-10px;'>Fraud Transaction Detection App</h1>
    """,
...
def main():
    ...
    # Show sidebar if get_started button is clicked
